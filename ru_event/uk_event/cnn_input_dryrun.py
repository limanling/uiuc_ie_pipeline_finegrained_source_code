...
if __name__ == "__main__":
    ...
    types = []
    print('Creating intermediate files for input to argument classifer....')
    with open('uk_argument_classes.txt','r') as t:
        types = t.read().strip().split('\n')
    make_folders(types, args.output_folder)
    create_files(args.input_rsd_folder, args.input_merged_bio, os.path.join(args.output_folder,'business_startbus-Agent/'))
