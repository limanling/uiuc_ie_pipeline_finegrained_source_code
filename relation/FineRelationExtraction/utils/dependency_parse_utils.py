...
POS_TAGGER_SCRIPT = "/relation/DependencyParse/RDRPOSTagger/pSCRDRtagger/aida_pos_tagger.py"

DEPEND_PARSER_SCRIPT = "/relation/DependencyParse/NeuroNLP2/examples/aida_depend.py"
DEPEND_PUNCT_SET = ['.', '``', "''", ':', ',']
...
if __name__ == "__main__":
    lang_id = "en"
    aida_cache_dir = "/relation/FineRelationExtraction/utils/tmp"
    aida_pos_rdr = "/relation/DependencyParse/data/ud-treebanks-v2.3/UD_English-EWT/en_ewt-ud-train.conllx.pos.RDR"
    aida_pos_dict = "/relation/DependencyParse/data/ud-treebanks-v2.3/UD_English-EWT/en_ewt-ud-train.conllx.pos.DICT"
    dep_mod_path = "/relation/DependencyParse/models/"
