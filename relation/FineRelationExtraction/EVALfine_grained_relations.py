...
def load_arg_config(arg_config_resource, is_dict=True):
    if not is_dict:
...
def get_arg_config_defaults(args):
    arg_dict = {
        "hierarchy_dir": "/relation/FineRelationExtraction/data/yago_taxonomy_wordnet_single_parent.json",
        "rel_ont_fname": "/relation/FineRelationExtraction/data/relation_ontology_arg_labels_constraints.v8.txt",
        "depend_pattern_fname": "/relation/FineRelationExtraction/data/dependency_patterns.json",
        "outdir": "",
        "rsd_vis_dir": "",
